<template>
    <nav class="fixed w-full z-20 top-0 start-0 transition-all duration-200"
        ...
        <div class="flex flex-wrap items-center mx-5 md:ml-12 md:mr-20 py-4">
            ...
            <div class="flex ms-auto md:order-2 space-x-3 md:space-x-0 gap-2 md:gap-8 items-center rtl:space-x-reverse">
                <a target="_blank" href="https://www.instagram.com/rhodescoffeeco/"> <i
                        class="fa-brands fa-instagram text-4xl"
                        :class="scrollPosition > 100 ? 'text-black' : 'text-white'"></i> </a>
                <Link href="/contact"
            ...
            <div class="ms-auto text-white items-center justify-between hidden w-full lg:flex md:w-auto md:order-1">
                <ul
                    ...
                    <li>
                        <Link href="/our-story" class="block py-2 px-3 rounded md:bg-transparent md:p-0"
                            aria-current="page" :class="(scrollPosition > 100) ? 'text-black' : 'text-white'"> Our Story
                        </Link>
                    </li>
                    <li>
                    ...
                    <li>
                        <Link href="/blogs" class="block py-2 px-3 rounded md:p-0 "
                            :class="scrollPosition > 100 ? 'text-gray-800' : 'text-gray-300'">Blogs</Link>
                    </li>
                    <li>
                        <Link href="/contact" class="block py-2 px-3 rounded md:p-0 "
                            :class="scrollPosition > 100 ? 'text-gray-800' : 'text-gray-300'">Contact</Link>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <footer class="grid md:grid-cols-3 text-center gap-10 py-24 px-20">
        ...
        <div class="">
            <ul class="flex flex-col gap-5">
                ...
                <li>
                    <Link href="/our-story" class="underline">Our Story</Link>
                </li>
                <li>
                    <Link href="/faqs" class="underline">FAQ</Link>
                </li>
